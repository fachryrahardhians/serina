      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              "${data.msg}",
              style: normalText.copyWith(fontSize: 13, color: Colors.white),
              textAlign: TextAlign.justify,
            ),
          ),
          Text(
            '${data.time?.toStringAMPM()}',
            style: smallText.copyWith(color: const Color(0xff808C92)),
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              "${data.msg}",
              style: normalText.copyWith(fontSize: 13, color: Colors.black),
              textAlign: TextAlign.justify,
            ),
          ),
          Text(
            '${data.time?.toStringAMPM()}',
            style: smallText.copyWith(color: Color(0xff808C92)),
          ),
        ],
      ),
    );
